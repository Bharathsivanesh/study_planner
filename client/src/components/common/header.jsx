...
const BottomNav = () => {
  ...
  return (
    <div
      className="fixed bottom-5 left-1/2 transform -translate-x-1/2 lg:w-[25rem] md:w-[24rem] sm:w-[18rem] w-[17rem] bg-primary_box
      ...
      <div className="flex items-center justify-between">
        {searchMode ? (
          <div className="flex items-center w-full gap-2 relative">
            <button
              className="text-white text-xl absolute right-1 top-8"
          ...
          navItems.map((item) => (
            <button
              ...
              onClick={() =>
                item.id === "search" ? handleSearchClick() : setActive(item.id)
              }
            >
